# Import from files
from utils.helper_functions import create_grading_prompt, create_feedback_prompt,student, gt, rubric
...
class GeminiModel():
    ...
    def model_pipeline(self, prompt: str, **kwargs) -> str:
        """Full pipeline to generate parsed model output from a prompt."""
        
        print(f"Input prompt: {prompt}")
        # Step 1: Format the input prompt
        formatted_input = self.format_input(prompt=prompt, **kwargs)
